pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/ferrana'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/angel-ferrana/225-lab5-1.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('ferrana-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e HOME=${WORKSPACE} \
                    -e BURP_START_URL=http://10.48.229.153 \
